...
echo $form->field($model, 'breed')->dropDownList($model->breeds);
...
echo $form->field($model, 'microchipped')->radiolist(['No', 'Yes']);
echo $form->field($model, 'neutered')->radiolist(['No', 'Yes']);
